...
app.get('/support-objects', async (req, res) => {
    try {
...
// Endpoint for adding a client via SOAP
...
app.post('/get-client-info', async (req, res) => {
    try {
        // Destructure the required fields from req.body
...
app.post('/get-all-options', async (req, res) => {
    try {
        // Destructure the required fields from req.body
...
app.post('/get-all-isbn', async (req, res) => {
    try {
        // Destructure the required fields from req.body
        const { api_log, api_key } = req.body;
...
app.post('/get-all-auteurs', async (req, res) => {
    try {
        // Destructure the required fields from req.body
        const { api_log, api_key } = req.body;
...
app.post('/get-all-product-stock', async (req, res) => {
    try {
        // Destructure the required fields from req.body
...
app.post('/get-tb-commandes', async (req, res) => {
    try {
        // Destructure the required fields from req.body
